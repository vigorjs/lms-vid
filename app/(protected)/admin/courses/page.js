...
export default async function AdminCoursesPage() {
  await requireUser(["ADMIN"]); const courses = await db.course.findMany({ include: { category: true, teacher: true, _count: { select: { assignments: { where: { student: { role: "STUDENT", status: "ACTIVE" } } } } } }, orderBy: { updatedAt: "desc" } });
